...
bossRunLogic:
    ...
    call bossLogic                                     ;; 04:40a0 $cd $a4 $40
    ret                                                ;; 04:40a3 $c9
...
bossLogic:
    ...
    call Z, bossNextHeadAction                         ;; 04:40b8 $cc $09 $42
    jr   Z, .return                                    ;; 04:40bb $28 $34
    ld   DE, wBossObjectsStatsRuntimeData              ;; 04:40bd $11 $42 $d4
    call bossDoHeadAction                              ;; 04:40c0 $cd $9e $41
    push AF                                            ;; 04:40c3 $f5
    ld   A, [HL+]                                      ;; 04:40c4 $2a
    ld   C, A                                          ;; 04:40c5 $4f
    sra  A                                             ;; 04:40c6 $cb $2f
    ...
    add  A, D                                          ;; 04:40db $82
    ld   D, A                                          ;; 04:40dc $57
    call setBossCurrentHeadYX                          ;; 04:40dd $cd $88 $41
    ld   A, [wBossFirstObjectID]                       ;; 04:40e0 $fa $e8 $d3
    ld   C, A                                          ;; 04:40e3 $4f
    pop  AF                                            ;; 04:40e4 $f1
    call updateObjectPosition                          ;; 04:40e5 $cd $11 $06
    pop  DE                                            ;; 04:40e8 $d1
    call bossMoveBodyObjects                           ;; 04:40e9 $cd $f3 $40
...
; A is always zero at this point.
    call MultiplyHL_by_A                               ;; 04:4104 $cd $7b $2b
    ld   A, [wBossCurrentMetatileListPointer.high]     ;; 04:4107 $fa $41 $d4
    ld   D, A                                          ;; 04:410a $57
    ld   A, [wBossCurrentMetatileListPointer]          ;; 04:410b $fa $40 $d4
    ld   E, A                                          ;; 04:410e $5f
    add  HL, DE                                        ;; 04:410f $19
    ld   A, [HL]                                       ;; 04:4110 $7e
    cp   A, $ff                                        ;; 04:4111 $fe $ff
    call Z, bossUnusedFunction                         ;; 04:4113 $cc $48 $41
    pop  AF                                            ;; 04:4116 $f1
    ld   B, A                                          ;; 04:4117 $47
...
.loop:
    ...
    ld   L, C                                          ;; 04:412a $69
    ld   A, B                                          ;; 04:412b $78
    call bossDoHeadAction                              ;; 04:412c $cd $9e $41
    ld   C, L                                          ;; 04:412f $4d
    pop  HL                                            ;; 04:4130 $e1
    push AF                                            ;; 04:4131 $f5
    ld   A, [HL+]                                      ;; 04:4132 $2a
...
; Never called in my playthrough.
bossUnusedFunction:
...
getBossCurrentHeadYX:
    ...
    ld   HL, wBossCurrentHeadYX                        ;; 04:4160 $21 $f6 $d3
...
; Used by Megapede to make every body link follow the head.
; Unused Megapede graphics show this may have had limitations.
getBossCurrentHeadXYAndIncrementStep:
    push HL                                            ;; 04:416b $e5
    push AF                                            ;; 04:416c $f5
...
.jr_04_417a:
    ...
    ld   HL, wBossCurrentHeadYX                        ;; 04:417d $21 $f6 $d3
...
setBossCurrentHeadYX:
    push HL                                            ;; 04:4188 $e5
    push AF                                            ;; 04:4189 $f5
    push DE                                            ;; 04:418a $d5
    ld   HL, wBossObjectsStatsRuntimeData.XYSaveIndex  ;; 04:418b $21 $46 $d4
    ld   A, [HL]                                       ;; 04:418e $7e
    add  A, A                                          ;; 04:418f $87
    ld   E, A                                          ;; 04:4190 $5f
    ld   D, $00                                        ;; 04:4191 $16 $00
    ld   HL, wBossCurrentHeadYX                        ;; 04:4193 $21 $f6 $d3
...
; A = first byte of a head action
; DE = stats runtime data address for the current head
; Return: DE = head location yx
bossDoHeadAction:
    ld   C, A                                          ;; 04:419e $4f
...
.nojump:
    ...
    push HL                                            ;; 04:41b6 $e5
    push BC                                            ;; 04:41b7 $c5
    ld   HL, .headActionTypeJumptable                  ;; 04:41b8 $21 $c5 $41
...
bossHeadActionSpawnProjectile:
    ...
    pop  DE                                            ;; 04:41e2 $d1
    call getBossCurrentHeadYX                          ;; 04:41e3 $cd $56 $41
    ret                                                ;; 04:41e6 $c9

bossHeadActionStartDeathScript:
    push DE                                            ;; 04:41e7 $d5
    ...
    pop  DE                                            ;; 04:4200 $d1
    call getBossCurrentHeadYX                          ;; 04:4201 $cd $56 $41
    ret                                                ;; 04:4204 $c9

; Used by Megapede
bossHeadActionGetHeadLocationAndStartNewHead:
    call getBossCurrentHeadXYAndIncrementStep          ;; 04:4205 $cd $6b $41
    ret                                                ;; 04:4208 $c9

bossNextHeadAction:
    ld   HL, wBossCurrentKeyframeHoldtime              ;; 04:4209 $21 $f0 $d3
    dec  [HL]                                          ;; 04:420c $35
    call Z, bossNextKeyframe                           ;; 04:420d $cc $22 $42
...
bossNextKeyframe:
    ld   A, [wBossCurrentKeyframeStep]                 ;; 04:4222 $fa $ed $d3
    ld   L, A                                          ;; 04:4225 $6f
    add  A, A                                          ;; 04:4226 $87
    add  A, A                                          ;; 04:4227 $87
    add  A, L                                          ;; 04:4228 $85
    ...
    ld   A, [wBossCurrentKeyframePointer.high]         ;; 04:422c $fa $3d $d4
    ld   D, A                                          ;; 04:422f $57
    ld   A, [wBossCurrentKeyframePointer]              ;; 04:4230 $fa $3c $d4
    ld   E, A                                          ;; 04:4233 $5f
...
bossInitPattern:
    ld   [wBossCurrentKeyframeHoldtime], A             ;; 04:4240 $ea $f0 $d3
    ld   E, [HL]                                       ;; 04:4243 $5e
    inc  HL                                            ;; 04:4244 $23
    ld   D, [HL]                                       ;; 04:4245 $56
    inc  HL                                            ;; 04:4246 $23
    ...
    ld   L, A                                          ;; 04:4251 $6f
    ld   A, H                                          ;; 04:4252 $7c
    ld   [wBossCurrentMetatileListPointer.high], A     ;; 04:4253 $ea $41 $d4
    ld   A, L                                          ;; 04:4256 $7d
    ld   [wBossCurrentMetatileListPointer], A          ;; 04:4257 $ea $40 $d4
    ld   HL, wBossCurrentKeyframeStep                  ;; 04:425a $21 $ed $d3
    inc  [HL]                                          ;; 04:425d $34
    ret                                                ;; 04:425e $c9
...
bossChoosePattern:
    ...
    ld   A, [wBossCurrentPatternStep]                  ;; 04:4266 $fa $ec $d3
    ld   L, A                                          ;; 04:4269 $6f
    add  A, A                                          ;; 04:426a $87
    add  A, A                                          ;; 04:426b $87
    add  A, L                                          ;; 04:426c $85
    ...
    add  A, A                                          ;; 04:4295 $87
    ld   D, A                                          ;; 04:4296 $57
    call setBossCurrentHeadYX                          ;; 04:4297 $cd $88 $41
    ...
    ld   H, [HL]                                       ;; 04:42a6 $66
    ld   L, A                                          ;; 04:42a7 $6f
    call bossNextPatternStep                           ;; 04:42a8 $cd $b0 $42
    ret                                                ;; 04:42ab $c9
.dead:
...
bossNextPatternStep:
    ...
    ld   A, L                                          ;; 04:42b5 $7d
    ld   [wBossCurrentKeyframePointer], A              ;; 04:42b6 $ea $3c $d4
    ld   HL, wBossCurrentPatternStep                   ;; 04:42b9 $21 $ec $d3
    inc  [HL]                                          ;; 04:42bc $34
    ld   A, $00                                        ;; 04:42bd $3e $00
    ld   [wBossCurrentKeyframeStep], A                 ;; 04:42bf $ea $ed $d3
    pop  HL                                            ;; 04:42c2 $e1
    ld   A, [HL+]                                      ;; 04:42c3 $2a
    ret                                                ;; 04:42c4 $c9
...
spawnBoss:
    ...
    ld   [wBossCurrentKeyframeHoldtime], A             ;; 04:4324 $ea $f0 $d3
    ld   [wBossSpeedTimer], A                          ;; 04:4327 $ea $e9 $d3
    call setBossMovement                               ;; 04:432a $cd $d8 $42
    call bossChoosePattern                             ;; 04:432d $cd $5f $42
...
bossLoadTiles:
    ...
    ld   A, [HL]                                       ;; 04:4377 $7e
    push DE                                            ;; 04:4378 $d5
    call projectileLoadTiles_trampoline                ;; 04:4379 $cd $dd $2b
    pop  DE                                            ;; 04:437c $d1
    push DE                                            ;; 04:437d $d5
...
bossCreateObjects:
    ...
    ld   HL, wBossObjectsStatsRuntimeData              ;; 04:43dc $21 $42 $d4
.loop:
    push BC                                            ;; 04:43df $c5
    push DE                                            ;; 04:43e0 $d5
    push HL                                            ;; 04:43e1 $e5
...
bossInitStatsObjectsRuntimeData:
    ...
    inc  HL                                            ;; 04:440a $23
    ld   D, [HL]                                       ;; 04:440b $56
    ld   HL, wBossObjectsStatsRuntimeData              ;; 04:440c $21 $42 $d4
.loop:
    inc  HL                                            ;; 04:440f $23
    ld   [HL], E                                       ;; 04:4410 $73
    inc  HL                                            ;; 04:4411 $23
...
bossClearStatsObjects:
    ...
    ld   HL, wBossObjectsStatsRuntimeData              ;; 04:442a $21 $42 $d4
...
.loop:
    ...
    push BC                                            ;; 04:4435 $c5
    ld   C, A                                          ;; 04:4436 $4f
    call destroyObject                                 ;; 04:4437 $cd $e3 $0a
    pop  BC                                            ;; 04:443a $c1
    pop  HL                                            ;; 04:443b $e1
...
.finishedBloodSwordHeal:
    ...
    ld   A, H                                          ;; 04:44c7 $7c
    ld   [wDamageDoneToBoss.high], A                   ;; 04:44c8 $ea $f3 $d3
    ld   A, L                                          ;; 04:44cb $7d
    ld   [wDamageDoneToBoss], A                        ;; 04:44cc $ea $f2 $d3
...
.jr_04_44eb:
    ...
    ld   A, L                                          ;; 04:4506 $7d
    ld   [wDamageDoneToBoss], A                        ;; 04:4507 $ea $f2 $d3
...
.followerAttack:
    ...
    ld   A, L                                          ;; 04:454c $7d
    ld   [wDamageDoneToBoss], A                        ;; 04:454d $ea $f2 $d3
    call processHitBoss                                ;; 04:4550 $cd $28 $47
    ret                                                ;; 04:4553 $c9
.immune:
    ld   HL, $00                                       ;; 04:4554 $21 $00 $00
    ld   A, H                                          ;; 04:4557 $7c
    ld   [wDamageDoneToBoss.high], A                   ;; 04:4558 $ea $f3 $d3
    ld   A, L                                          ;; 04:455b $7d
    ld   [wDamageDoneToBoss], A                        ;; 04:455c $ea $f2 $d3
...
.unused:
    ...
    ld   A, L                                          ;; 04:456e $7d
    ld   [wDamageDoneToBoss], A                        ;; 04:456f $ea $f2 $d3
...
processBossDeath:
    ...
    call bossClearStatsObjects                         ;; 04:4591 $cd $25 $44
...
bossKilled:
    ...
    pop  DE                                            ;; 04:45d7 $d1
    ld   E, A                                          ;; 04:45d8 $5f
    call setBossCurrentHeadYX                          ;; 04:45d9 $cd $88 $41
    ...
    ld   [wBossCurrentKeyframeHoldtime], A             ;; 04:45ed $ea $f0 $d3
    ld   [wBossSpeedTimer], A                          ;; 04:45f0 $ea $e9 $d3
    call bossNextPatternStep                           ;; 04:45f3 $cd $b0 $42
    call bossNextHeadAction                            ;; 04:45f6 $cd $09 $42
    ret                                                ;; 04:45f9 $c9

bossTakeDamage:
    ld   A, [wDamageDoneToBoss.high]                   ;; 04:45fa $fa $f3 $d3
    ld   H, A                                          ;; 04:45fd $67
    ld   A, [wDamageDoneToBoss]                        ;; 04:45fe $fa $f2 $d3
    ld   L, A                                          ;; 04:4601 $6f
    res  7, H                                          ;; 04:4602 $cb $bc
    ld   BC, $00                                       ;; 04:4604 $01 $00 $00
    ld   A, B                                          ;; 04:4607 $78
    ld   [wDamageDoneToBoss.high], A                   ;; 04:4608 $ea $f3 $d3
    ld   A, C                                          ;; 04:460b $79
    ld   [wDamageDoneToBoss], A                        ;; 04:460c $ea $f2 $d3
    ld   A, H                                          ;; 04:460f $7c
    or   A, L                                          ;; 04:4610 $b5
    ret  Z                                             ;; 04:4611 $c8
    call subHPBoss                                     ;; 04:4612 $cd $0b $47
    jr   Z, .killed                                    ;; 04:4615 $28 $01
    ret  NC                                            ;; 04:4617 $d0
.killed:
