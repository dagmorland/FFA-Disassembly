...
.jr_03_4163:
    ...
    call objectReverseDirection                        ;; 03:416a $cd $e4 $29
    pop  BC                                            ;; 03:416d $c1
    push BC                                            ;; 03:416e $c5
...
.jr_03_4288:
    ...
    ld   C, A                                          ;; 03:4289 $4f
    push DE                                            ;; 03:428a $d5
    call checkStepAnimation                            ;; 03:428b $cd $0c $0c
    pop  DE                                            ;; 03:428e $d1
...
npcLoadTiles:
    ...
    ld   A, [HL]                                       ;; 03:43f7 $7e
    call projectileLoadTiles_trampoline                ;; 03:43f8 $cd $dd $2b
    pop  HL                                            ;; 03:43fb $e1
...
.loop:
    ...
    ld   [HL], A                                       ;; 03:447a $77
    push BC                                            ;; 03:447b $c5
    call npcLoadTiles                                  ;; 03:447c $cd $dc $43
    pop  BC                                            ;; 03:447f $c1
    pop  HL                                            ;; 03:4480 $e1
    inc  HL                                            ;; 03:4481 $23
    inc  HL                                            ;; 03:4482 $23
...
; Return: DE = random yx tile number between (02,02) and ($10,$0d)
getRandomTile:
    push HL                                            ;; 03:44cd $e5
    push BC                                            ;; 03:44ce $c5
.loop_1:
...
; Get enemy DP in E, divided by 4 if vulnerable
    call getEnemyDPIncludingVulnerability              ;; 03:470e $cd $6e $49
    push DE                                            ;; 03:4711 $d5
; Get total AP (the number shown in the EQUIP screen) in A
    call getTotalAP                                    ;; 03:4712 $cd $0e $3d
; Move AP into HL, and multiply by 3/4 for certain special attacks
    call specialAttack2Power75inHLNpc                  ;; 03:4715 $cd $85 $49
    pop  DE                                            ;; 03:4718 $d1
; HL = (HL - E) + (HL - E) * (ChargePercent) + (HL - E) * (random between 0 and 25%)
...
.jr_03_4777:
    ...
    call getEnemyDPIncludingVulnerability              ;; 03:477c $cd $6e $49
    push DE                                            ;; 03:477f $d5
...
; BC offset for DP or Magic DP
; HL base offset for NPC stats
; Return: DP in E, divided by 4 if vulnerable
getEnemyDPIncludingVulnerability:
    push HL                                            ;; 03:496e $e5
...
; A = base AP
; Return: HL = A, or for certain special attacks, HL = 3/4 * A
...
; E = DP (possibly adjusted downward for elemental vulnerability)
; HL = AP (possibly adjusted downward for certain special attacks)
; Return: (AP - DP) + (AP - DP) * (ChargePercent) + (AP - DP) * (random between 0 and 25%)
calculateWeaponDamageToNPC:
    ld   D, $00                                        ;; 03:499b $16 $00
    call sub_HL_DE                                     ;; 03:499d $cd $ab $2b
    jr   C, .damage_negative                           ;; 03:49a0 $38 $1f
    ret  Z                                             ;; 03:49a2 $c8
    push HL                                            ;; 03:49a3 $e5
    ...
    pop  DE                                            ;; 03:49bc $d1
    call add25rndDEtoHL_3                              ;; 03:49bd $cd $f6 $49
    ret                                                ;; 03:49c0 $c9
.damage_negative:
...
.jr_03_49d7:
    ...
    pop  DE                                            ;; 03:49ec $d1
    call add25rndDEtoHL_3                              ;; 03:49ed $cd $f6 $49
    ret                                                ;; 03:49f0 $c9
.jr_03_49f1:
...
; Return: DE = HL
; Return: HL = HL + DE * random between 0 and 25%
add25rndDEtoHL_3:
    push HL                                            ;; 03:49f6 $e5
    push DE                                            ;; 03:49f7 $d5
...
moveObjectDuringScript:
    inc  C                                             ;; 03:4b19 $0c
    push BC                                            ;; 03:4b1a $c5
    push HL                                            ;; 03:4b1b $e5
    cp   A, $ff                                        ;; 03:4b1c $fe $ff
    jr   Z, .player                                    ;; 03:4b1e $28 $22
...
moveObjectsDuringScript:
    ld   HL, wObjectsMovingDuringScript                ;; 03:4b4f $21 $a0 $c5
...
getEmptyObjectsMovingDuringScriptSlot:
    ld   HL, wObjectsMovingDuringScript                ;; 03:4b62 $21 $a0 $c5
...
objectBehaviorMove:
    ...
    push DE                                            ;; 03:4b92 $d5
    ld   A, [DE]                                       ;; 03:4b93 $1a
    call getEmptyObjectsMovingDuringScriptSlot         ;; 03:4b94 $cd $62 $4b
    pop  DE                                            ;; 03:4b97 $d1
    pop  BC                                            ;; 03:4b98 $c1
    jr   Z, .jr_03_4bdd                                ;; 03:4b99 $28 $42
    push BC                                            ;; 03:4b9b $c5
    ld   A, $00                                        ;; 03:4b9c $3e $00
    call getEmptyObjectsMovingDuringScriptSlot         ;; 03:4b9e $cd $62 $4b
    pop  BC                                            ;; 03:4ba1 $c1
    ret  NZ                                            ;; 03:4ba2 $c0
    ld   [HL], C                                       ;; 03:4ba3 $71
...
.jr_03_4ba6:
    ...
    call getEmptyObjectsMovingDuringScriptSlot         ;; 03:4bae $cd $62 $4b
    pop  BC                                            ;; 03:4bb1 $c1
    ret  NZ                                            ;; 03:4bb2 $c0
    ld   [HL], C                                       ;; 03:4bb3 $71
    ret                                                ;; 03:4bb4 $c9
.player:
    ...
    call getEmptyObjectsMovingDuringScriptSlot         ;; 03:4bbf $cd $62 $4b
    jr   Z, .jr_03_4bdd                                ;; 03:4bc2 $28 $19
    ld   A, $00                                        ;; 03:4bc4 $3e $00
    call getEmptyObjectsMovingDuringScriptSlot         ;; 03:4bc6 $cd $62 $4b
    ret  NZ                                            ;; 03:4bc9 $c0
...
npcActionJumptable:
    ...
    dw   npcWalkInPlaceWithMovingHold2                 ;; 03:4c79 ?? $12
...
npcWalkInPlaceWithMovingHold2:
    ld   A, C                                          ;; 03:5025 $79
    cp   A, $00                                        ;; 03:5026 $fe $00
    ld   C, $3c
    call Z, call_03_55cb                               ;; 03:502a $cc $cb $55
    call processDelayWithMovingHold
    ret                                                ;; 03:5030 $c9
...
jr_03_53da:
    ...
    call npcSetMeleeState                              ;; 03:53fe $cd $bc $28
    pop  AF                                            ;; 03:5401 $f1
    ret                                                ;; 03:5402 $c9
...
.jr_03_54fc:
    ...
    pop  DE                                            ;; 03:550b $d1
    call checkObjectTileCollisions                     ;; 03:550c $cd $c0 $18
...
npcBehaviorTable:
    ...
    db   $02, $02, $07, $06, $07, $06, $07, $08, $04, $04, $04, $04, $04, $04, $0f, $0f, $09, $09, $09, $09, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10 ;; 03:569e .....................?.??....??? $03
    db   $07, $06, $07, $06, $07, $06, $07, $08, $04, $04, $04, $04, $04, $04, $04, $04, $07, $06, $07, $06, $07, $06, $07, $08, $04, $04, $04, $04, $04, $04, $04, $10 ;; 03:56be .................??............. $04
    db   $0a, $0a, $0a, $0a, $0a, $0b, $0b, $0b, $0b, $0b, $04, $04, $04, $04, $04, $0f, $06, $07, $0e, $04, $04, $0f, $0f, $0f, $0a, $0a, $0a, $0a, $0b, $0b, $0b, $0b ;; 03:56de ................................ $05
    db   $0a, $0a, $0a, $0a, $0b, $0b, $0b, $0b, $04, $04, $04, $04, $04, $02, $02, $0f, $02, $02, $06, $07, $0e, $0f, $0f, $0f, $0a, $0a, $0a, $0b, $0a, $0b, $0b, $0b ;; 03:56fe ???????????????????????????????? $06
    db   $0b, $0b, $0b, $0b, $0b, $24, $24, $24, $24, $48, $48, $48, $0e, $0e, $0e, $0e, $0b, $0b, $0b, $0b, $0b, $0b, $0b, $0b, $24, $24, $24, $24, $24, $24, $0b, $0b ;; 03:571e ???????????????????????????????? $07
    db   $0a, $0a, $0a, $0a, $0a, $24, $24, $24, $24, $48, $48, $48, $0e, $0e, $0e, $0e, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $24, $24, $24, $24, $24, $24 ;; 03:573e ???????????????????????????????? $08
    db   $0b, $0b, $0b, $0b, $0b, $0b, $0b, $0b, $64, $68, $68, $70, $64, $0e, $0e, $0e, $68, $69, $6a, $6b, $65, $65, $69, $69, $65, $69, $78, $79, $70, $75, $74, $75 ;; 03:575e ???????????????????????????????? $09
    db   $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $64, $68, $68, $70, $64, $0e, $0e, $0e, $68, $69, $6a, $6b, $65, $65, $69, $69, $65, $69, $78, $79, $74, $75, $74, $75 ;; 03:577e ???????????????????????????????? $0a
    db   $06, $07, $20, $20, $20, $20, $20, $20, $20, $21, $21, $11, $11, $0f, $0f, $22, $24, $24, $24, $06, $06, $06, $06, $07, $07, $07, $07, $11, $4a, $4b, $09, $0e ;; 03:579e ?.????..????..?.???????????????? $0b
    db   $06, $07, $02, $02, $20, $20, $20, $20, $20, $21, $21, $11, $11, $0f, $0f, $22, $24, $24, $24, $06, $06, $06, $06, $07, $07, $07, $07, $11, $4a, $4b, $09, $0e ;; 03:57be ???????????????????????????????? $0c
    db   $0f, $4c, $4d, $4e, $4f, $49, $4a, $4b, $48, $0f, $0f, $11, $54, $55, $54, $55, $0f, $0f, $0f, $06, $06, $06, $07, $07, $07, $24, $24, $24, $10, $10, $09, $09 ;; 03:57de ..........................?..... $0d
    db   $0f, $4c, $4d, $4e, $4f, $49, $4a, $4b, $48, $02, $02, $11, $4e, $4f, $4e, $4f, $0f, $0f, $0f, $06, $06, $06, $07, $07, $07, $24, $24, $24, $10, $10, $09, $09 ;; 03:57fe ..?.............?..?????.??????? $0e
    db   $6c, $6d, $6e, $6f, $74, $75, $74, $75, $78, $79, $7a, $7b, $6e, $6f, $11, $0f, $6c, $6d, $6e, $6f, $74, $75, $6e, $6f, $00, $00, $70, $69, $72, $73, $11, $09 ;; 03:581e .....................??.??..?.?. $0f
    db   $13, $13, $78, $79, $10, $10, $6c, $6d, $04, $7b, $7a, $06, $07, $11, $11, $0f, $74, $75, $6e, $6f, $7b, $7a, $7b, $11, $11, $05, $70, $11, $0f, $06, $07, $09 ;; 03:583e ................??...?????.???.? $10
    db   $13, $78, $79, $28, $28, $6c, $6d, $04, $7b, $7a, $06, $07, $02, $02, $02, $0f, $74, $75, $6e, $6f, $7b, $7a, $7b, $02, $02, $05, $70, $11, $0f, $06, $07, $09 ;; 03:585e ???????????????????????????????? $11
    db   $06, $07, $06, $07, $06, $07, $06, $08, $28, $28, $24, $24, $24, $24, $0f, $0f, $90, $90, $92, $93, $94, $95, $94, $95, $98, $99, $9a, $9b, $98, $99, $9a, $9b ;; 03:587e .....?....?..?.????????.??..???. $12
    db   $06, $07, $06, $07, $06, $07, $02, $02, $02, $02, $24, $24, $24, $24, $0f, $0f, $90, $90, $92, $93, $94, $95, $94, $95, $98, $99, $9a, $9b, $98, $99, $9a, $9b ;; 03:589e ???????????????????????????????? $13
    db   $10, $10, $06, $07, $06, $07, $06, $07, $08, $24, $24, $28, $28, $28, $0f, $0f, $d4, $d5, $d6, $d7, $d4, $d5, $d6, $d7, $d8, $d9, $da, $db, $dc, $dd, $de, $df ;; 03:58be ???????????????????????????????? $14
    db   $10, $10, $06, $07, $06, $07, $06, $02, $02, $02, $02, $28, $28, $28, $0f, $0f, $cc, $cd, $ce, $cf, $d4, $d5, $d6, $d7, $d8, $d9, $da, $db, $dc, $dd, $de, $df ;; 03:58de ???????????????????????????????? $15
    ...
    db   $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $0a, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10, $10 ;; 03:59de ???????????????????????????????? $1d

INCLUDE "data/npc/stats.asm"

INCLUDE "data/npc/main.asm"
